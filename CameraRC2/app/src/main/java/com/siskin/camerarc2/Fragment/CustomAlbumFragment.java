...
public class CustomAlbumFragment extends AbsBoxingViewFragment implements View.OnClickListener {
    ...
    public static com.bilibili.boxing_impl.ui.BoxingViewFragment newInstance() {
        return new com.bilibili.boxing_impl.ui.BoxingViewFragment();
    }
    ...
    private void updateOkBtnState(List<BaseMedia> medias) {
        ...
        mOkBtn.setText(enabled ? getString(com.bilibili.boxing_impl.R.string.boxing_image_select_ok_fmt, String.valueOf(medias.size())
                , String.valueOf(mMaxCount)) : getString(com.bilibili.boxing_impl.R.string.boxing_ok));
    }
/*
    @Override
